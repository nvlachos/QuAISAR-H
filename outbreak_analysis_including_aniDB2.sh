...
python3 "${shareScript}/project_parser_aniDB2.py" -s "${output_directory}/${4}-sample_summary.txt" -p "${output_directory}/${4}-plasmid_summary.txt" -o "${output_directory}/${4}_AR_plasmid_report_aniDB2.tsv" -d "${ResGANNCBI_srst2_filename}"
