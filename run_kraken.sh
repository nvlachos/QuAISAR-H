...
# Runs kraken on the assembly
	...
	echo "2"
	kraken-translate --db "${kraken2_mini_db}" "${OUTDATADIR}/kraken/${2}Assembly/${1}_${3}_BP.kraken" > "${OUTDATADIR}/kraken/${2}Assembly/${1}_${3}_BP.labels"
	# Create an mpa report
	echo "3"
	kraken-mpa-report --db "${kraken2_mini_db}" "${OUTDATADIR}/kraken/${2}Assembly/${1}_${3}_BP.kraken" > "${OUTDATADIR}/kraken/${2}Assembly/${1}_${3}_weighted.mpa"
