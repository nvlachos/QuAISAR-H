...
def do_AR(input_summary_AR, input_plas, output_file, DB_name):
		...
		for GAMA_gene in GAMA_list:
			if GAMA_gene[0] == "No AR genes discovered":
				...
				if gene_name not in all_ARs_in_file:
					all_ARs_in_file.append(gene_name)
			#break
		samples.append([summary_line_sections[0], summary_line_sections[1], summary_line_sections[2], summary_line_sections[3],  summary_line_sections[4], summary_line_sections[5], summary_line_sections[6], summary_line_sections[7], summary_line_sections[8], summary_line_sections[9], summary_line_sections[10], summary_line_sections[11], ar_dict])
	...
	header="id, Project__autocolour, Species__autocolour, Species_determinant__autocolour, Species_Support__autocolour , Species2__autocolour, Species_determinant2__autocolour, Species_Support2__autocolour, MLST_Pasteur__autocolour, MLST_Pasteur_alleles__autocolour, ALT_MLST__autocolour, ALT_MLST_alleles__autocolour, AR_Database__autocolour, "
