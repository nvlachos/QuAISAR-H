...
if [[ -s "${processed}/${2}/${1}/Assembly/${1}_scaffolds_trimmed.fasta" ]]; then
	...
	ml bowtie2/2.3.5.1 samtools/1.9 bam2fastq/1.1.0 Unicycler/0.4.7 gcc/5.4 SPAdes/3.13.0 racon/1.3.1 perl/5.26.1
...
ml -bowtie2/2.3.5.1 -samtools/1.9 -bam2fastq/1.1.0 -Unicycler/0.4.7 -gcc/5.4 -SPAdes/3.13.0 -racon/1.3.1 -perl/5.26.1 R/3.1
