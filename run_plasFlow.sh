...
if [[ -s "${processed}/${2}/${1}/Assembly/${1}_scaffolds_trimmed.fasta" ]]; then
	...
	ml bowtie2/2.2.9 samtools/1.4.1 bam2fastq/1.1.0 Unicycler/0.4.4 gcc/4.9.3 SPAdes/3.13.0 racon/1.3.1 perl/5.22.1
...
ml -Python3/3.5.4 -bowtie2/2.2.9 -samtools/1.4.1 -bam2fastq/1.1.0 -Unicycler/0.4.4 -gcc/4.9.3 -SPAdes/3.13.0 -racon/1.3.1 -perl/5.22.1
